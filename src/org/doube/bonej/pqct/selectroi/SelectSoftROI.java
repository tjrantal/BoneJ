...
import java.util.Arrays;	//Vector, Collections
	...
	public SelectSoftROI(final ScaledImageData dataIn, final ImageAndAnalysisDetails detailsIn, final ImagePlus imp,
		...
		if (details.stOn) {
			...
			try{
				...
				subCutaneousFat = Arrays.copyOf(muscleSieve,muscleSieve.length);	//Changed 2016/01/08
				...
				eroded = new byte[softSieve.length];	//Changed 2016/01/08
